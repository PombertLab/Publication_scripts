#!/usr/bin/perl
## Pombert Lab, 2018
my $name = 'make_PHAST_datasets.pl';
my $version = 0.1;
...
NAME		$name
VERSION		$version
SYNOPSIS	Creates Fasta datasets for PHAST (http://compgen.cshl.edu/phast/) from Orthofinder orthogroups output files
EXAMPLE		make_PHAST_datasets.pl -f mRNAs.fasta -c file.csv
